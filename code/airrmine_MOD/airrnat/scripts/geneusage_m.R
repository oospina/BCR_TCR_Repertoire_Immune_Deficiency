...
#c_gu <- countGenes( seqdb,gene="isotype", mode="asis",copy="duplicate_count" ) # No C-domain in Marta's data
vdjc_gu <- select( bind_rows( v_gu, d_gu, j_gu#, c_gu # No C-domain in Marta's data
                              ), c("seq_count","gene") )
